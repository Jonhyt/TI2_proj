...
namespace TI2_proj.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Genero.Where(a => a.Dono == User.Identity.Name).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "GeneroID,Nome,Dono")] Genero genero)
        {

            if (ModelState.IsValid)
            {
                genero.Dono = User.Identity.Name;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GeneroID,Nome,Dono")] Genero genero)
        {
            if (ModelState.IsValid)
            {
